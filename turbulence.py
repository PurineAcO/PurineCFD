...
def Spalart_Allmaras(cell:cc.cell_class):
    ...
    cell.DiffuTurb[1] = [tau_xx, tau_xy]   
    cell.DiffuTurb[2] = [tau_xy, tau_yy]   
    cell.DiffuTurb[3] = [cell.u*tau_xx + cell.v*tau_xy - q_x,
                        cell.u*tau_xy + cell.v*tau_yy - q_y]  
    cell.DiffuTurb[4] = [cc.sigma * (mu + cell.U[5] + cc.Cb2*cell.U[5]) * cell.miublgrad[1],
